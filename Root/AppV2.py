...
if uploaded_file is not None:
    ...
    # 2 Drop or fill mostly empty columns
    ...
    for col in df_clean.columns:
        ...
        if missing_ratio > threshold:
            if df_clean[col].dtype in ['int64', 'float64', 'object']:
                st.sidebar.write(f" Column '{col}' has {missing_ratio:.0%} missing values — dropping.")
    ...
    for col in numeric_cols:
        ...
        if outlier_count > 0:
            ...
            st.sidebar.write(f" Capped {outlier_count} outliers in '{col}'.")
    ...
    if null_counts == 0:
        ...
        st.sidebar.write(f" {null_counts} null values still present after cleaning.")
